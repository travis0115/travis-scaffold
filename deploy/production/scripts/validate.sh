...
required_variables=(
    ...
    ROCKETMQ_NAMESRV_ADDR ROCKETMQ_CONSUMER_ENDPOINTS ROCKETMQ_CONSUMER_ACCESS_KEY
    ROCKETMQ_CONSUMER_SECRET_KEY ROCKETMQ_PRODUCER_ENDPOINTS
    ROCKETMQ_PRODUCER_ACCESS_KEY ROCKETMQ_PRODUCER_SECRET_KEY
)
