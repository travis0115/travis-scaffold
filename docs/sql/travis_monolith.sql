...
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (4, '消息推送状态', 'sys_message_status', 1, '0-待推送 1-已推送 2-已撤回', 0, '2026-06-26 09:59:51', 1, '2026-07-03 09:31:31', NULL, 4);
...
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (8, '消息类型', 'sys_message_type', 1, '1-系统消息 2-业务消息 3-系统公告 4-版本更新', 0, '2026-07-12 17:20:00', 1, NULL, NULL, 8);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (9, '消息阅读状态', 'sys_message_read_status', 1, '0-未读 1-已读', 0, '2026-07-12 17:20:00', 1, NULL, NULL, 9);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (10, '消息接收范围', 'sys_message_receiver_scope', 1, '0-全部用户 1-指定用户 2-指定角色 3-指定部门', 0, '2026-07-12 17:20:00', 1, NULL, NULL, 10);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (11, '消息接收端', 'sys_message_receiver_type', 1, 'admin-后台账号 app-客户端用户', 0, '2026-07-12 17:20:00', 1, NULL, NULL, 11);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (12, '是否置顶', 'is_pinned', 1, '0-否 1-是', 0, '2026-06-25 15:42:59', 1, '2026-07-03 10:02:58', 1, 12);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (13, '启用状态', 'enable_status', 1, '0-禁用\n1-启用', 0, '2026-05-24 01:54:11', 1, '2026-07-03 10:02:52', 1, 13);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (14, '在线状态', 'online_status', 1, '0-离线 1-在线', 0, '2026-06-28 15:59:35', 1, '2026-07-03 09:31:58', NULL, 14);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (15, '操作结果', 'operation_status', 1, '0-失败\n1-成功', 0, '2026-07-03 02:20:27', 1, '2026-07-03 10:21:00', NULL, 15);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (2070500000000000001, '操作业务类型', 'operation_business_type', 1, '', 0, '2026-07-04 01:00:42', 1, '2026-07-03 17:01:16', 1, 16);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (2073032019189133314, '请求方式', 'http_method', 1, '', 0, '2026-07-03 13:12:03', 1, '2026-07-03 13:12:21', 1, 17);
INSERT INTO `sys_dict` (`id`, `dict_name`, `dict_code`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`, `sort`) VALUES (2076400000000000001, '发布状态', 'sys_publish_status', 1, '0-草稿 1-已发布 2-已撤回', 0, '2026-07-13 00:00:00', 1, NULL, NULL, 18);
COMMIT;
...
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (9, 4, '已推送', '1', 'success', 2, 1, NULL, 0, '2026-06-26 09:59:51', 1, '2026-07-03 10:03:48', NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (10, 4, '已撤回', '2', 'danger', 3, 1, NULL, 0, '2026-06-26 09:59:51', 1, '2026-07-03 10:03:50', NULL);
...
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076300000000000001, 6, '系统公告', 'NOTICE', 'warning', 2, 1, NULL, 0, '2026-07-13 00:00:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076300000000000002, 6, '版本更新', 'VERSION', 'info', 3, 1, NULL, 0, '2026-07-13 00:00:00', 1, NULL, NULL);
...
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000001, 8, '系统消息', '1', 'primary', 1, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000002, 8, '业务消息', '2', 'success', 2, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076300000000000003, 8, '系统公告', '3', 'warning', 3, 1, NULL, 0, '2026-07-13 00:00:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076300000000000004, 8, '版本更新', '4', 'info', 4, 1, NULL, 0, '2026-07-13 00:00:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000003, 9, '未读', '0', 'warning', 1, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000004, 9, '已读', '1', 'success', 2, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000005, 10, '全部用户', '0', 'primary', 1, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000006, 10, '指定用户', '1', 'success', 2, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000007, 10, '指定角色', '2', 'warning', 3, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000008, 10, '指定部门', '3', 'info', 4, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000009, 11, '后台账号', 'admin', 'primary', 1, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076200000000000010, 11, '客户端用户', 'app', 'success', 2, 1, NULL, 0, '2026-07-12 17:20:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (19, 12, '否', '0', 'default', 0, 1, '', 0, '2026-06-25 15:44:15', 1, '2026-07-03 10:04:00', 1);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (20, 12, '置顶', '1', 'primary', 1, 1, NULL, 0, '2026-06-25 15:44:28', 1, '2026-07-03 10:04:01', NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (21, 13, '启用', '1', 'success', 1, 1, NULL, 0, '2026-05-24 01:54:11', 1, '2026-07-03 10:04:02', 1);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (22, 13, '禁用', '0', 'danger', 2, 1, NULL, 0, '2026-05-24 01:54:11', 1, '2026-07-03 10:04:03', 1);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (23, 14, '离线', '0', 'default', 2, 1, NULL, 0, '2026-06-28 16:22:20', 1, '2026-07-03 10:04:04', NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (24, 14, '在线', '1', 'success', 1, 1, NULL, 0, '2026-06-28 16:22:31', 1, '2026-07-03 10:04:06', NULL);
...
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2072873955806928897, 15, '成功', '1', 'success', 1, 1, NULL, 0, '2026-07-03 02:43:58', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2072873991148134402, 15, '失败', '0', 'danger', 2, 1, NULL, 0, '2026-07-03 02:44:06', 1, NULL, NULL);
...
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076400000000000002, 2076400000000000001, '草稿', '0', 'default', 1, 1, NULL, 0, '2026-07-13 00:00:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076400000000000003, 2076400000000000001, '已发布', '1', 'success', 2, 1, NULL, 0, '2026-07-13 00:00:00', 1, NULL, NULL);
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `label`, `value`, `tag_style`, `sort`, `status`, `remark`, `is_deleted`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES (2076400000000000004, 2076400000000000001, '已撤回', '2', 'danger', 3, 1, NULL, 0, '2026-07-13 00:00:00', 1, NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_notice` (
  ...
  `sort` int NOT NULL DEFAULT '999' COMMENT '排序号',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  `is_deleted` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_by` bigint NOT NULL COMMENT '创建人ID',
