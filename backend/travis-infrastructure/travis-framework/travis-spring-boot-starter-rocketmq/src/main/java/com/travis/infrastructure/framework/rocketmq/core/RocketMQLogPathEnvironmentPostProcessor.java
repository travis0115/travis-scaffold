 ...
 *
 * <p>rocketmq-client-java（v5 gRPC 客户端）内置 shaded logback，
 * 在类加载阶段就会读取 {@code rocketmq.log.root} 系统属性初始化日志。
 * 普通的 Spring Bean 或 AutoConfiguration 执行时已经太晚，
 * 必须通过 {@link EnvironmentPostProcessor} 在环境准备阶段就设置好。
 *
