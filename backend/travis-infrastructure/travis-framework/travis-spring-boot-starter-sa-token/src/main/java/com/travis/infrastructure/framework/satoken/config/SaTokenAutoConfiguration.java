...
import com.travis.infrastructure.framework.satoken.core.exception.SaTokenExceptionHandler;
import com.travis.infrastructure.framework.satoken.core.log.UserContextMDCInterceptor;
...
public class SaTokenAutoConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(@NonNull InterceptorRegistry registry) {
        ...
        // 注册用户上下文拦截器
        registry.addInterceptor(new UserContextMDCInterceptor())
                .addPathPatterns("/api/**")
