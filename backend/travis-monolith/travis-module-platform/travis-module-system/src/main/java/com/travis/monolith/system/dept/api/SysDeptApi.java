...
public interface SysDeptApi {
     ...
     * @return 部门ID -> 部门名称的映射
     */
    Map<Long, String> getDeptNameMapByIds(Collection<@NotNull(message = "部门ID不能为空") Long> ids);
     ...
     */
    boolean existsAnyByIds(Collection<@NotNull(message = "部门ID不能为空") Long> deptIds);
